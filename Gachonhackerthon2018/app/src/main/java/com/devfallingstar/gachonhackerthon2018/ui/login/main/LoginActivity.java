...
import com.devfallingstar.gachonhackerthon2018.helper.firebase.FirebaseAuthHelper;
...
public class LoginActivity extends BasicActivity implements BasicActivityInterface {

    private static final String TAG = "LoginActivity";
    FirebaseAuthHelper firebaseAuthHelper;
    private static final int RC_SIGN_IN = 9001; // Request code for google signin
    ...
    @OnClick(R.id.btn_gmailSignUp)
    protected void signInWithGmail() {
